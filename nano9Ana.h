...
public:
  struct Hists {
    ...
    TH1F *muprop[20]; //This is an array of 20 histograms.
    TH1F *nElectron;
    TH1F *Electronpt;
    TH1F *Electronprop[20];
    TH1F *Photonprop[20];
    TH1F *prachu[10];
    TH1F *Jet[20];
    TH1F *GenMu_StatusID;
    ...
    TH1F *Delta_R_Mu_Ele;
    TH1F *Delta_R_GenMu_RecoMu;
    TH1F *Min_Delta_R_GenElectron_RecoElectron;
    TH1F *Min_Delta_R_GenMu_RecoMu;
    TH1F *GenPart_pdgID;
    TH1F *Electron_cutBased;
    TH1F *GenMother_pdgID;
  };
  ...
  int GenMatching(Lepton reco, vector<Lepton> gen);
protected:
  Hists h;
...
private:
  ...
  // Declare arrays here:
  //######################
  vector<Lepton> goodMu,goodElectron,goodPhoton,goodJet,good_bJet,GenMu,GenElectron;
